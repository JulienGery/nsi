...
class card{
    ...
    constructor(x, y, z, texture, px, py, pz){
        this.x = x;
        this.y = y;
        this.z = z
...
new card(1, 1, 0.1, "https://avatars.githubusercontent.com/u/75223846?s=400&v=4", 0, 0, 0)
new card(1, 1, .1, "/snkellefaitpeur.png", 1.2, 0, 0)
new card(1, 1, 0.1, "https://avatars.githubusercontent.com/u/75223846?s=400&v=4", 1.2, 1.2, 0)
new card(1, 1, .1, "/snkellefaitpeur.png", 0, 1.2, 0)
// Mesh


// scene.add(carte)
// console.log(carte.uuid)
// scene.add(carte2)
